...
<html lang="en">
  <head>
    ...
    <script src="<?= URLROOT;?>/js/multipleAdd.js" defer></script>
    <!-- custon style Sheet & JavaScript -->
    ...
    <div class="container fs-montserrat">
      ...
      <div class="products">
        <div class="recent-orders">
          ...
          <form action="<?php echo URLROOT;?>/products/add" method="POST" id="formProducts" enctype="multipart/form-data">
                ...
                <div class="row ms-1">
                <button class="col-2 mt-4 btn btn-success" type="submit">ADD</button>
                </div>
