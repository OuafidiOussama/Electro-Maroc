            ...
            <div class="products">
              <div class="recent-orders">
                <div class="card-header">
                  <h2>Products</h2>
                  <a href="<?= URLROOT?>/products/add" class="btn"><i class="uil uil-pen"></i> Add Product</a>
                </div>
                <table>
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><img  src="<?php echo URLROOT. '/product/' . $products->reference ; ?>" alt="" width="60px" height="60px" ></td>
                      <td><?php echo $products->label?></td>
                      <td>$<?php echo $products->retail_price?></td>
                      <td>$<?php echo $products->final_price?></td>
                      <td>$<?php echo $products->selling_price?></td>
                      <td><?php echo $products->description?></td>
                      <td><?php echo $products->name?></td>
                      <td>
                        <a href="<?= URLROOT . '/products/edit/' . $products->id ?>"><button class="update">Update</button></a>
                        <a href="<?= URLROOT . '/products/delete/' . $products->id ?>" ><button class="delete" id="confirm_delete">Delete</button></a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
